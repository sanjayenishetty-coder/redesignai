    ...
    <div className="redesign-page" ref={containerRef}>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub fade-up delay-2">
            ...
            In 2 days at ISB Hyderabad, you walk out with live systems, not notes.
          </p>
      ...
      <section className="speaker-section" id="faculty">
        <div className="section-inner">
          ...
          <h2 className="section-h2 fade-up delay-1">Learn from practitioners, not just professors.</h2>
          ...
          <div className="pricing-layout">
            <div className="pricing-left">
              ...
              <div className="roi-block group-pricing-block fade-up delay-2">
                ...
                <p className="group-pricing-desc">Group discounts apply to early bird registrations only. Standard pricing applies after the early bird window closes.</p>
                <div className="roi-comparison">
                  <div className="roi-row">
              ...
              <div className="urgency-block fade-up delay-3">
                ...
                <div className="urgency-text">
                  <strong>Early bird pricing ends soon</strong>
                  <span>Once the early bird window closes, the price returns to ₹50,000 and group discounts no longer apply. Reserve your seat now to lock in your rate.</span>
                </div>
              </div>
            </div>
            ...
            <div className="pricing-card fade-up delay-2">
              <div className="early-bird-badge">🐦 Early Bird, Ends Soon</div>
              ...
              <div className="early-bird-save">Early Bird Pricing, Save ₹11,000</div>
            ...
            <div>
              ...
              <ul className="footer-col-items">
                <li>
                  ...
                  hello@redesignworkshop.in
                </li>
                <li>
                  <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 11.3 19.79 19.79 0 0 1 1.61 2.68 2 2 0 0 1 3.59.5h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.05a16 16 0 0 0 6.06 6.06l.88-.88a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.5 15.5z"/></svg>
                  +91 98765 43210
                </li>
              </ul>
            </div>
